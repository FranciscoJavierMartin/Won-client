...
describe('<Heading />', () => {
  ...
  it('should render a white heading when white color is passed', () => {
    renderWithTheme(<Heading>Won Games</Heading>);
    expect(screen.getByRole('heading', { name: /won games/i })).toHaveStyle({
      color: '#FAFAFA',
    });
  ...
  it('should render a heading without a line to the left side', () => {
    renderWithTheme(<Heading>Won Games</Heading>);
  ...
  it('should render a heading without a line at the bottom', () => {
    renderWithTheme(<Heading>Won Games</Heading>);
    expect(
